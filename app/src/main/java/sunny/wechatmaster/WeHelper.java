...
import sunny.wechatmaster.domain.EmojiconExampleGroupData;
import sunny.wechatmaster.domain.InviteMessage;
import sunny.wechatmaster.domain.RobotUser;
import sunny.wechatmaster.parse.UserProfileManager;
import sunny.wechatmaster.receiver.CallReceiver;
import sunny.wechatmaster.ui.ChatActivity;
import sunny.wechatmaster.ui.MainActivity;
import sunny.wechatmaster.utils.PreferenceManager;
...
public class WeHelper {
    ...
    protected static final String TAG = "WeHelper";
    ...
    private static WeHelper instance = null;

    private WeModel weModel = null;
    ...
    public synchronized static WeHelper getInstance() {
        if (instance == null) {
            instance = new WeHelper();
        }
        return instance;
    }
    ...
    protected void setEaseUIProviders() {
        ...
        easeUI.setSettingsProvider(new EaseUI.EaseSettingsProvider() {
            ...
            public boolean isSpeakerOpened() {
                return weModel.getSettingMsgSpeaker();
            }

            @Override
            public boolean isMsgVibrateAllowed(EMMessage message) {
                return weModel.getSettingMsgVibrate();
            }

            @Override
            public boolean isMsgSoundAllowed(EMMessage message) {
                return weModel.getSettingMsgSound();
            }

            @Override
            public boolean isMsgNotifyAllowed(EMMessage message) {
                if(message == null){
                    return weModel.getSettingMsgNotification();
                }
                if(!weModel.getSettingMsgNotification()){
                    return false;
                }else{
                    //如果允许新消息提示
                    //屏蔽的用户和群组不提示用户
                    ...
                    if (message.getChatType() == EMMessage.ChatType.Chat) {
                        ...
                        notNotifyIds = weModel.getDisabledIds();
                    } else {
                        chatUsename = message.getTo();
                        notNotifyIds = weModel.getDisabledGroups();
                    }
...
//                    intent = new Intent(appContext, VoiceCallActivity.class);
    ...
    protected void setGlobalListeners(){
        ...
        isGroupsSyncedWithServer = weModel.isGroupsSynced();
        isContactsSyncedWithServer = weModel.isContactSynced();
        isBlackListSyncedWithServer = weModel.isBacklistSynced();
            ...
            public void onConnected() {
                ...
                if(isGroupsSyncedWithServer && isContactsSyncedWithServer){
                    new Thread(){
                        @Override
                        public void run(){
                            WeHelper.getInstance().notifyForRecevingEvents();
                        }
                    }.start();
                }else{
    ...
    private void initDbDao() {
        inviteMessgeDao = new InviteMessageDao(appContext);
    ...
    public class MyContactListener implements EMContactListener {
        ...
        public void onContactDeleted(String username) {
            // 被删除
            Map<String, EaseUser> localUsers = WeHelper.getInstance().getContactList();
    ...
    public Map<String, EaseUser> getContactList() {
        if (isLoggedIn() && contactList == null) {
            contactList = weModel.getContactList();
        }
    ...
    public void setCurrentUserName(String username){
        ...
        weModel.setCurrentUserName(username);
    }
    ...
    public String getCurrentUsernName(){
        if(username == null){
            username = weModel.getCurrentUsernName();
        }
        return username;
    }
    ...
    public Map<String, RobotUser> getRobotList() {
        if (isLoggedIn() && robotList == null) {
            robotList = weModel.getRobotList();
        }
        return robotList;
    }
        ...
        new Thread(){
            ...
            public void run(){
                ...
                try {
                    ...
                    weModel.setContactSynced(false);
                    isContactsSyncedWithServer = false;
                    isSyncingContactsWithServer = false;
                    notifyContactsSyncListener(false);
                    e.printStackTrace();
        ...
        new Thread(){
            ...
            public void run(){
                try {
                    ...
                    weModel.setBlacklistSynced(true);
                    ...
                    weModel.setBlacklistSynced(false);

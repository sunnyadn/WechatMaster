...
//	private ChatAllHistoryFragment conversationListFragment;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null && savedInstanceState.getBoolean(Constant.ACCOUNT_REMOVED, false)) {
            ...
            // 三个fragment里加的判断同理
            WeHelper.getInstance().logout(true,null);
            finish();
...
//        contactListFragment = new ContactListFragment();
        ...
        fragments = new Fragment[] { conversationListFragment, settingFragment };
        // 添加显示第一个fragment
    ...
    EMMessageListener messageListener = new EMMessageListener() {
        ...
        public void onMessageReceived(List<EMMessage> messages) {
            ...
            for (EMMessage message : messages) {
                WeHelper.getInstance().getNotifier().onNewMsg(message);
            }
...
//                    unreadAddressLable.setVisibility(View.INVISIBLE);
    ...
    private void notifyNewIviteMessage(InviteMessage msg) {
        saveInviteMsg(msg);
        // 提示有新消息
        WeHelper.getInstance().getNotifier().viberateAndPlayTone(null);
...
//            contactListFragment.refresh();
    ...
    protected void onResume() {
        ...
        // background
        WeHelper sdkHelper = WeHelper.getInstance();
    ...
    private void showConflictDialog() {
        ...
        WeHelper.getInstance().logout(false,null);
    ...
    private void registerInternalDebugReceiver() {
        internalDebugReceiver = new BroadcastReceiver() {
            ...
            @Override
            public void onReceive(Context context, Intent intent) {
                WeHelper.getInstance().logout(false,new EMCallBack() {

 ...
 */
public class WeDBManager {
    static private WeDBManager dbMgr = new WeDBManager();
    private DbOpenHelper dbHelper;

    private WeDBManager(){
        dbHelper = DbOpenHelper.getInstance(WeApplication.getInstance().getApplicationContext());
    }

    public static synchronized WeDBManager getInstance(){
        if(dbMgr == null){
            dbMgr = new WeDBManager();
        }
        return dbMgr;
    }

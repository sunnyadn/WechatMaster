...
public class ParseManager {
    ...
    private static final String ParseAppID = "YXA6dBGzcAJdEeaFJu0a51US0w";
    private static final String ParseClientKey = "YXA6CVsCrGA92IXki6p6JE1I8Sq3aeM";
        ...
        pQuery.getFirstInBackground(new GetCallback<ParseObject>() {
            ...
            public void done(ParseObject pUser, ParseException e) {
                if(pUser!=null){
                    ...
                    if(callback!=null){
                        EaseUser user = WeHelper.getInstance().getContactList().get(username);
                        if(user!=null){
                            user.setNick(nick);

package sunny.wechatmaster.parse;
...
public class UserProfileManager {
     ...
     */
    private List<WeHelper.DataSyncListener> syncContactInfosListeners;
    ...
    public synchronized boolean init(Context context) {
        ...
        syncContactInfosListeners = new ArrayList<WeHelper.DataSyncListener>();
        sdkInited = true;
        return true;
    }

    public void addSyncContactInfoListener(WeHelper.DataSyncListener listener) {
        if (listener == null) {
            return;
        }
    ...
    public void removeSyncContactInfoListener(WeHelper.DataSyncListener listener) {
        if (listener == null) {
            return;
        }
        if (syncContactInfosListeners.contains(listener)) {
    ...
    public void notifyContactInfosSyncListener(boolean success) {
        for (WeHelper.DataSyncListener listener : syncContactInfosListeners) {
